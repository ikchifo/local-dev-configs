...
- Write clear, concise, and informative comments. Only include comments that add value and context to the code. Avoid redundant or obvious comments especially when the variable or function name is self-explanatory.
